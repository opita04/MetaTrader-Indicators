...
extern bool		AllowMobileNotification		= FALSE;
...
int start() {
	...
	if (timeFrame != Period())
	{
	   for (int i=Bars-1; i>= 0; i--)
	   {
	      ...
	      line1[i] = iCustom(NULL,timeFrame,indicatorFileName,0,NoRepaint,MinorMinExtremeHeightATRs,MajorToMinorHeightRatio,MinorMinExtremeWidth,MajorMinExtremeWidth,AlertMajorBottomEnabled,AlertMajorTopEnabled,AlertMinorTopEnabled,AlertMinorBottomEnabled,AlertStableEnabled,AllowMobileNotification,0,y);
	      line2[i] = iCustom(NULL,timeFrame,indicatorFileName,0,NoRepaint,MinorMinExtremeHeightATRs,MajorToMinorHeightRatio,MinorMinExtremeWidth,MajorMinExtremeWidth,AlertMajorBottomEnabled,AlertMajorTopEnabled,AlertMinorTopEnabled,AlertMinorBottomEnabled,AlertStableEnabled,AllowMobileNotification,1,y);
	      line3[i] = iCustom(NULL,timeFrame,indicatorFileName,0,NoRepaint,MinorMinExtremeHeightATRs,MajorToMinorHeightRatio,MinorMinExtremeWidth,MajorMinExtremeWidth,AlertMajorBottomEnabled,AlertMajorTopEnabled,AlertMinorTopEnabled,AlertMinorBottomEnabled,AlertStableEnabled,AllowMobileNotification,2,y);
	      line4[i] = iCustom(NULL,timeFrame,indicatorFileName,0,NoRepaint,MinorMinExtremeHeightATRs,MajorToMinorHeightRatio,MinorMinExtremeWidth,MajorMinExtremeWidth,AlertMajorBottomEnabled,AlertMajorTopEnabled,AlertMinorTopEnabled,AlertMinorBottomEnabled,AlertStableEnabled,AllowMobileNotification,3,y);
	      line5[i] = iCustom(NULL,timeFrame,indicatorFileName,0,NoRepaint,MinorMinExtremeHeightATRs,MajorToMinorHeightRatio,MinorMinExtremeWidth,MajorMinExtremeWidth,AlertMajorBottomEnabled,AlertMajorTopEnabled,AlertMinorTopEnabled,AlertMinorBottomEnabled,AlertStableEnabled,AllowMobileNotification,4,y);
	   }
	   return(0);
	}
	for( ; BarNumber < Bars; ) {
	...
	switch( alertType ) {
			...
			switch( lineType ) {
				case LINE_MAJOR:
					if( AlertMajorTopEnabled && (barTime != AlertMajorTopIdx) ) {
						msg = Symbol() + " " + periodName + ": Major Top Detected";
						Alert( msg );
						if( AllowMobileNotification )
				...
				case LINE_MINOR:
					if( AlertMinorTopEnabled && (barTime != AlertMinorTopIdx) ) {
						msg = Symbol() + " " + periodName + ": Minor Top Detected";
						Alert( msg );
						if( AllowMobileNotification )
							SendNotification( msg );
			...
			switch( lineType ) {
				case LINE_MAJOR:
					if( AlertMajorBottomEnabled && (barTime != AlertMajorBottomIdx) ) {
						msg = Symbol() + " " + periodName + ": Major Bottom Detected";
						Alert( msg );
						if( AllowMobileNotification )
							SendNotification( msg );
				...
				case LINE_MINOR:
					if( AlertMinorBottomEnabled && (barTime != AlertMinorBottomIdx) ) {
						msg = Symbol() + " " + periodName + ": Minor Bottom Detected";
						Alert( msg );
						if( AllowMobileNotification )
							SendNotification( msg );
		...
		case ALERT_STABLE:
			if( AlertStableEnabled && (barTime != AlertStableIdx) ) {
				msg = Symbol() + " " + periodName + ": Latest extreme will not repaint anymore";
				Alert( msg );
				if( AllowMobileNotification )
					SendNotification( msg );
